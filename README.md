...
As you may expect, "base" is the base conda environment, and "py3" is the one we created. However this is connected to the login node, and we **never run code on the login node**. Instead, see [this gist about running jupyter notebooks on clusters](https://gist.github.com/CianMRoche/ce176a089c06fd81d26f339f99f5af87)
